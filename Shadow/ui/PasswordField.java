...
extends Gui {
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            if (string.length() > 0) {
                ...
                n6 = Minecraft.getMinecraft().fontRendererObj.drawString(this.text.replaceAll("(?s).", "*"), n4, n5, n);
            }
            ...
            if (string.length() > 0 && bl && n2 < string.length()) {
                Minecraft.getMinecraft().fontRendererObj.drawString(string.substring(n2), n6, n5, n);
            }
            if (bl2) {
                if (bl3) {
                    Gui.drawRect(n7, n5 - 1, n7 + 1, n5 + 1 + this.fontRenderer.FONT_HEIGHT, -3092272);
                } else {
                    Minecraft.getMinecraft().fontRendererObj.drawString("_", n7, n5, n);
                }
            }
            if (n3 != n2) {
    ...
    public void writeText(String string) {
        ...
        if (this.text.length() > 0) {
            string2 = String.valueOf(new StringBuilder(String.valueOf(String.valueOf(String.valueOf(string2)))).append(this.text.substring(0, n2)));
        }
        if (n4 < string3.length()) {
            string2 = String.valueOf(new StringBuilder(String.valueOf(String.valueOf(String.valueOf(string2)))).append(string3.substring(0, n4)));
            n = n4;
        } else {
            string2 = String.valueOf(new StringBuilder(String.valueOf(String.valueOf(String.valueOf(string2)))).append(string3));
            n = string3.length();
        }
        if (this.text.length() > 0 && n3 < this.text.length()) {
            string2 = String.valueOf(new StringBuilder(String.valueOf(String.valueOf(String.valueOf(string2)))).append(this.text.substring(n3)));
        }
        ...
        if (this.text.length() != 0) {
            if (this.selectionEnd != this.cursorPosition) {
                ...
                if (n3 < this.text.length()) {
                    string = String.valueOf(new StringBuilder(String.valueOf(String.valueOf(String.valueOf(string)))).append(this.text.substring(n3)));
                }
                this.text = string;
                if (bl) {
                    this.cursorPos(n);
